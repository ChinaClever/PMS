# Generated by Django 4.1.3 on 2023-11-23 17:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solution', models.CharField(help_text='解决方法', max_length=150, verbose_name='解决方法')),
                ('notes', models.CharField(help_text='备注', max_length=150, null=True, verbose_name='备注')),
                ('repair_time', models.DateTimeField(help_text='维修日期', verbose_name='维修日期')),
            ],
            options={
                'verbose_name': '维修报表',
