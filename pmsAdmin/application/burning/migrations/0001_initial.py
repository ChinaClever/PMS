# Generated by Django 4.1.3 on 2024-01-10 14:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.CharField(help_text='开始日期', max_length=255, null=True, verbose_name='开始日期')),
                ('finish_time', models.CharField(help_text='完成日期', max_length=255, null=True, verbose_name='完成日期')),
                ('work_hours', models.CharField(help_text='完成日期', max_length=255, null=True, verbose_name='所用工时')),
            ],
            options={
                'verbose_name': '烧录表',
