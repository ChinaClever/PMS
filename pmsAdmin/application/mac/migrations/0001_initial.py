# Generated by Django 4.1.3 on 2023-11-29 15:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text='产品型号', max_length=50, verbose_name='产品型号')),
                ('serial_id', models.CharField(help_text='序列号', max_length=50, null=True, verbose_name='序列号')),
                ('mac_address', models.CharField(help_text='mac地址', max_length=50, null=True, unique=True, verbose_name='mac地址')),
            ],
            options={
                'verbose_name': 'mac管理表',
