        ...
        <ele-pro-table
          ...
          <template slot="toolbar">
            <el-button
              ...
              class="ele-btn-icon"
              @click="openEdit(null)"
              v-if="permission.includes('sys:welding:add')">添加
            </el-button>
            <el-button
              size="small"
              type="danger"
              ...
              class="ele-btn-icon"
              @click="removeBatch"
              v-if="permission.includes('sys:welding:dall')">删除
            </el-button>
            <!-- <el-button
            ...
            <el-button
              ...
              class="ele-btn-icon"
              @click="exportExcel"
              v-if="permission.includes('sys:welding:export')">导出
            </el-button>
          </template>
          <!-- 操作列 -->
          <template slot="action" slot-scope="{row}">
            <el-link
              ...
              icon="el-icon-edit"
              @click="openEdit(row)"
              v-if="permission.includes('sys:welding:update')">修改
            </el-link>
            <el-popconfirm
              class="ele-action"
              title="确定要删除此数据吗？"
              ...
              <el-link
                ...
                :underline="false"
                icon="el-icon-delete"
                v-if="permission.includes('sys:welding:delete')">删除
              </el-link>
            </el-popconfirm>
          </template>
          <!-- 状态列 -->
